(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["ng-image-fullscreen-view"] = {}, global.ng.core, global.ng.common, global.ng.platformBrowser));
    ...
    NgImageFullscreenViewService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NgImageFullscreenViewService_Factory() { return new NgImageFullscreenViewService(); }, token: NgImageFullscreenViewService, providedIn: "root" });
    ...
    var NgImageFullscreenViewComponent = /** @class */ (function () {
        function NgImageFullscreenViewComponent(cdRef, sanitizer, elRef, imageFullscreenViewService, document) {
            ...
            this.prevImage = new i0.EventEmitter();
            this.nextImage = new i0.EventEmitter();
        }
    ...
    NgImageFullscreenViewComponent.propDecorators = {
        ...
        imageIndex: [{ type: i0.Input }],
        show: [{ type: i0.Input }],
        videoAutoPlay: [{ type: i0.Input }],
        direction: [{ type: i0.Input }],
        paginationShow: [{ type: i0.Input }],
        animationSpeed: [{ type: i0.Input }],
        infinite: [{ type: i0.Input }],
        arrowKeyMove: [{ type: i0.Input }],
        showVideoControls: [{ type: i0.Input }],
        close: [{ type: i0.Output }],
        prevImage: [{ type: i0.Output }],
        nextImage: [{ type: i0.Output }],
